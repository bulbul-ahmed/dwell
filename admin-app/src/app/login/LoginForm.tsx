    ...
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <label style={{ display: 'block' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <input
            ...
            onFocus={e => (e.target.style.borderColor = '#1E3A5C')}
      ...
      <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', userSelect: 'none' }}>
        <div
          ...
          style={{
            ...
            background: remember ? '#C9A24B' : '#fff',
      ...
      <button
        ...
        style={{
          ...
          background: loading
            ? '#AEB8C6'
            : 'linear-gradient(135deg, #D4A84B 0%, #C9A24B 40%, #A67C2E 100%)',
          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
          boxShadow: loading ? 'none' : '0 12px 28px -8px rgba(180,140,40,.50)',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, justifyContent: 'center', marginTop: 4 }}>
        ...
        <span style={{ fontSize: 11.5, color: '#AEB8C6', fontWeight: 500 }}>
          Protected area · activity is logged &amp; monitored
        </span>
      </div>
    </form>
  );
